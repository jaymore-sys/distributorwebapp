...
function getAvatarBg(index) {
  const list = [
    "linear-gradient(180deg, #8ad7f7 0%, #53b6e2 100%)",
    "linear-gradient(180deg, #b7ecff 0%, #67c5ee 100%)",
    "linear-gradient(180deg, #92dff9 0%, #3eaad8 100%)",
    "linear-gradient(180deg, #b2dce9 0%, #71b7d1 100%)",
    "linear-gradient(180deg, #7ed0ef 0%, #309fd3 100%)",
  ];
...
function ThemeOverrides() {
  return (
    <style>{`
      ...
      [data-brand="bounce"] .bzd-secondary-btn {
        border-color: ${BRAND_ACCENT} !important;
        color: ${BRAND_ACCENT} !important;
      }

      [data-brand="bounce"] .bzd-filter-row button.active,
      [data-brand="bounce"] .bzd-total-card,
      [data-brand="bounce"] .bzd-history-hero,
      [data-brand="bounce"] .bzd-sales-card,
      [data-brand="bounce"] .bzd-qty-row button,
      [data-brand="bounce"] .bzd-review-total {
        background: linear-gradient(180deg, ${BRAND_GRAD_FROM} 0%, ${BRAND_GRAD_TO} 100%) !important;
        color: #fff !important;
      }

      [data-brand="bounce"] .bzd-sales-card h2,
      [data-brand="bounce"] .bzd-sales-card small,
      [data-brand="bounce"] .bzd-sales-card strong {
        color: #fff !important;
      }

      [data-brand="bounce"] .bzd-add-btn {
        background: ${BRAND_ACCENT} !important;
      }
      [data-brand="bounce"] .bzd-add-btn:disabled {
        background: ${BRAND_ACCENT}18 !important;
        color: ${BRAND_ACCENT} !important;
        border: 1.5px solid ${BRAND_ACCENT}40 !important;
      }

      [data-brand="bounce"] .bzd-bottom-nav button.active span {
        color: ${BRAND_ACCENT} !important;
      }

      [data-brand="bounce"] .bzd-bottom-nav button.active {
        color: ${BRAND_ACCENT} !important;
        background: ${BRAND_ACCENT}18 !important;
      }

      [data-brand="bounce"] .bzd-bottom-nav button.active svg path,
      [data-brand="bounce"] .bzd-bottom-nav button.active svg circle {
        stroke: ${BRAND_ACCENT} !important;
      }

      [data-brand="bounce"] .bzd-history-search input:focus,
      [data-brand="bounce"] .bzd-search-wrap input:focus,
      [data-brand="bounce"] .bzd-form-list input:focus,
      [data-brand="bounce"] .bzd-form-list select:focus {
        border-color: ${BRAND_ACCENT} !important;
        box-shadow: 0 0 0 3px rgba(83,182,226,0.08) !important;
      }

      [data-brand="bounce"] .bzd-success-actions .receipt {
        background: #eaf8fd !important;
        color: ${BRAND_ACCENT} !important;
      }

      [data-brand="bounce"] .bzd-section-head button {
        color: ${BRAND_ACCENT} !important;
      }

      [data-brand="bounce"] .bzd-success-icon {
