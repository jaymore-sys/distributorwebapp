...
const bounceLogo = `data:image/svg+xml;utf8,${encodeURIComponent(`
<svg xmlns="http://www.w3.org/2000/svg" width="420" height="160" viewBox="0 0 420 160">
  <rect width="420" height="160" rx="28" fill="#53b6e2"/>
  <text x="210" y="78" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="60" font-weight="700" fill="white">BOUNCE</text>
  <text x="210" y="118" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="22" font-weight="600" letter-spacing="3" fill="white">SUPERDRINKS</text>
</svg>
`)}`;
...
export default function BounceDistributorDashboard() {
  ...
  const handleWhatsappShare = () => {
    ...
    const text = `Hello ${lastOrder.shopName || ""}, your Bounce order ${
